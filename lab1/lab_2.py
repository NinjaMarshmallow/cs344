...
problem = {
    ...
    "starta": ["space on b", "c on a", "space on c", "b on table", "a on table", "space on table"],
    "finisha":["space on b", "space on c", "b on table", "a on table", "c on table", "space on a", "space on table"],
...
def main():
    ...
    start = problem['startb']
    finish = problem['finishb']
